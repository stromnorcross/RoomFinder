...
urlpatterns = [
    ...
    path("messages/<int:pk>/details/", views.MessageDetailView.as_view(), name="message_detail"),
    path("message/<int:pk>/details/delete", views.delete_message, name="delete_message"),
    path("messagess/", views.MessageListView.as_view(), name="message_list"),
